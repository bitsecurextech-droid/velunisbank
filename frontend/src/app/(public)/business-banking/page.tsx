      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '1.2rem', color: '#4a5b7a', maxWidth: '700px' }}>
            Corporate accounts, global payroll, and merchant services to power your enterprise.
          </p>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '60px' }}>
          {[
            { title: 'Corporate Accounts', desc: 'Multi‑user access, dedicated relationship manager, no minimum balance.', icon: 'fa-building' },
            { title: 'Payroll', desc: 'Automated salary disbursement in 120+ countries with zero fees.', icon: 'fa-users' },
            { title: 'Merchant Services', desc: 'Accept payments online and in‑store with competitive rates.', icon: 'fa-store' },
            { title: 'Business Loans', desc: 'Flexible financing up to $5M with fast approval.', icon: 'fa-chart-bar' },
          ].map((item) => (
